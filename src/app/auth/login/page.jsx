      ...
      <div className='container '>
        ...
        <div className='lg:mx-60 mt-7'>
          <form className='w-full' >
                ...
                <button className='bg-black hover:bg-secondary-300 text-white w-full py-4'>Login</button>
                <p className='text-[20px] font-medium py-2 text-center'>OR</p>
                <button className='bg-black hover:bg-secondary-300 text-white w-full py-4 flex items-center justify-center gap-x-4'> Login with google </button>
          </form>
        </div>
