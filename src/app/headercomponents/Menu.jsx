        ...
        {menuOpen && (
          <div className='bg-white absolute text-black left-0 top-28 w-full h-{calc(100vh-80px)} flex flex-col items-center justify-center gap-8 text-xl z-10'>
             ...
             <Link href="/about" className="text-xs">ABOUT US</Link>
                ...
                <img src="/profile.png" alt="Persona Icon" className="h-6 w-6 bg-white"/>
          
               <img src="/like.png" alt="like Icon" className="h-6 w-6"/>
          
                 <img src="/search.png" alt="search Icon" className="h-6 w-6"/>
                 <img src="/cart.png" alt="cart Icon" className="h-6 w-6"/> 
          </div>
        )}
    </div>
  )
